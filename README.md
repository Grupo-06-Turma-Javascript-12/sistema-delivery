...
O **Mastiga** é um sistema de delivery focado em alimentação saudável, desenvolvido como projeto prático pela Turma de JavaScript 12 (Grupo 06). O objetivo é facilitar o acesso a refeições nutritivas, oferecendo uma interface intuitiva para escolha de pratos e gestão de pedidos.
